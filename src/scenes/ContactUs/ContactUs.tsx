...
import ContactUsPageGraphic from "src/assets/entrepreneur.jpg";
  ...
  return (
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
      <motion.div onViewportEnter={highlightTab}>
        ...
        >
          <HText>
            <span className="text-primary-500">JOIN NOW</span> TO GET MORE INFO
          </HText>
          <p className="my-5">
           Interested in learning more? Feel free to drop us a message, and we'll be thrilled to provide you with all the information you need.
          </p>
        </motion.div>
        {/* FORM AND IMAGE */}
